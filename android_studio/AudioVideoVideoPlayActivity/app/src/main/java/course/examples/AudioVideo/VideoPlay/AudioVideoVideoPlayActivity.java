...
public class AudioVideoVideoPlayActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mVideoView.setVideoURI(Uri.parse("android.resource://course.examples.AudioVideo.VideoPlay-2/raw/moon"));
		
		//mVideoView.setVideoURI(Uri.parse("http://172.20.246.29/iphone/downloads/chZ/OTT.m3u8"));
