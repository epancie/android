...
public class ActivityLoaderActivity extends Activity {
	...
	private void startExplicitActivation() {
		...
		// class
		Intent iExplicitlyLoadedActivity = new Intent(
				ActivityLoaderActivity.this, ExplicitlyLoadedActivity.class);

		// TODO - Start an Activity using that intent and the request code
		// defined above
		startActivityForResult(iExplicitlyLoadedActivity, GET_TEXT_REQUEST_CODE);
	...
	private void startImplicitActivation() {
		...
		String text_uri = mUserTextView.getText().toString();
		Uri uri = Uri.parse("http://" + text_uri);
		Intent Implicit_Intent = new Intent( Intent.ACTION_VIEW, uri );
		...
		chooserIntent = Intent.createChooser(Implicit_Intent, CHOOSER_TEXT);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == Activity.RESULT_OK
			...
			//Log.i(TAG, "onActivityResult() resultCode OK and requestCode OK");

			try {
				String new_text = data.getStringExtra("user_input");
				//Log.i(TAG, "onActivityResult() URI:" + new_text);
				mUserTextView.setText(new_text);

			} catch (Exception e) {
				//Log.i(TAG, "onActivityResult() catch:" + e.toString());
			}
		}
	}
}
