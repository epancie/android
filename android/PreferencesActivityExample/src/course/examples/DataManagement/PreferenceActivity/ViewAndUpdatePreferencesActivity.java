...
public class ViewAndUpdatePreferencesActivity extends Activity {
	...
	public static class UserPreferenceFragment extends PreferenceFragment {
		...
		public void onCreate(Bundle savedInstanceState) {
			...
			mListener = new OnSharedPreferenceChangeListener() {
				...
				public void onSharedPreferenceChanged(
					...
					mUserNamePreference.setSummary(sharedPreferences.getString(
							USERNAME, "None Set"));
					Log.d(TAG,"listener to update summary when username changes -> onSharePreferenceChanged");
				}
			};
			...
			Log.d(TAG,"Inovoke callback manualy to display the current username -> onSharedPreferenceChanged");
