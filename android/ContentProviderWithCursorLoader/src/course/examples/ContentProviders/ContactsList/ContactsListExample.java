...
public class ContactsListExample extends ListActivity implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		// Initialize the loader .initLoader(id, arguments[], method that implement de loadcallbacks)
		getLoaderManager().initLoader(0, null, this);//this call several callbacks the first is onCreateLoader
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		//when this method finish -> onLoadFinish
	}
